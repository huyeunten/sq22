...
The variables with non-zero coefficients are utility_costs, share_renters_2016, share_overcrowded_units_2016, and total_Jan_precipitation.
...
I chose to look at how the location may have an effect on the most significant variables. The original large data set has a variable for the four census regions (northeast, midwest, south, west).
